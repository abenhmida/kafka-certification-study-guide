...
### 1.
What is the fundamental unit of parallelism in a Kafka topic?
...
### 3.
A topic has 12 partitions and a consumer group has 20 consumers. What is the maximum number of consumers that can actively consume partitions of that topic?
...
### 4.
What identifies the position of a record within a partition?
...
### 5.
What happens to a committed consumer offset when a consumer process restarts?
...
### 7.
What determines which partition receives a keyed record under the default partitioning strategy?
...
### 8.
What is a Kafka record key commonly used for?
...
### 10.
What is the leader replica responsible for?
...
### 13.
If two consumers belong to the same group and subscribe to the same six-partition topic, can both consume the same partition simultaneously under a normal group assignment?
...
### 14.
What is the purpose of a consumer offset?
...
### 15.
Which statement is true about Kafka retention?
...
### 16.
Which cleanup policy is associated with retaining the latest state for keys?
...
### 18.
What does idempotent producer behavior help prevent?
...
### 19.
What is the purpose of producer retries?
...
### 20.
What is `acks=all` intended to provide?
...
### 21.
What does `min.insync.replicas` influence?
...
### 23.
What usually triggers a consumer group rebalance?
...
### 24.
What is the main reason to have multiple partitions?
...
### 25.
Can Kafka guarantee ordering across all partitions of a topic?
...
### 26.
What does a partition leader represent?
...
### 27.
What does a consumer typically do after processing records successfully?
...
### 29.
What is exactly-once semantics intended to provide?
...
### 30.
What is a Kafka transaction used for?
...
### 31.
Which component stores Kafka records?
...
### 33.
What happens when a consumer is slower than the producer for an extended period?
...
### 34.
What does `auto.offset.reset` influence?
...
### 36.
What is the main advantage of manual offset management?
...
### 37.
What is a dead-letter topic commonly used for?
...
### 38.
What is a retry topic commonly used for?
...
### 40.
What is the main benefit of batching producer records?
...
### 41.
What does compression usually reduce?
...
### 42.
Which format is a binary serialization format commonly used with Kafka?
...
### 43.
What does Kafka Connect provide?
...
### 45.
What does a state store in Kafka Streams provide?
...
### 46.
What is a repartition topic used for in Kafka Streams?
...
### 47.
What is a changelog topic commonly used for in Kafka Streams?
...
### 49.
What is schema compatibility intended to protect?
...
### 50.
Which statement best summarizes Kafka?
